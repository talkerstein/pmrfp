...
insert into public.property_types (name, slug) values
  ...
  ('Townhome Complex','townhome-complex'),
  ('Student Housing','student-housing'),
  ('Purpose-Built Rental','purpose-built-rental'),
  ('Single-Family Rental Portfolio','single-family-rental-portfolio'),
...
-- ===== 20260529000007_auto_enable_rls.sql =====
